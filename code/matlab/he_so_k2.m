...
Nodes(1).name = 1; Nodes(1).Ptai = 3400; Nodes(1).Q = 130 + delQ;        Nodes(1).Udm = 22;  Nodes(1).PV = 150*2 + delPV;
Nodes(2).name = 2; Nodes(2).Ptai = 3600; Nodes(2).Q = 190 + delQ;        Nodes(2).Udm = 22;  Nodes(2).PV = 150*2 + delPV;
Nodes(3).name = 3; Nodes(3).Ptai = 3700; Nodes(3).Q = 140 + delQ;        Nodes(3).Udm = 22;  Nodes(3).PV = 160*2 + delPV;
Nodes(4).name = 4; Nodes(4).Ptai = 3300; Nodes(4).Q = 120 + delQ;        Nodes(4).Udm = 22;  Nodes(4).PV = 150*2 + delPV;
Nodes(5).name = 5; Nodes(5).Ptai = 3800; Nodes(5).Q = 100 + delQ;        Nodes(5).Udm = 22;  Nodes(5).PV = 180*2 + delPV;
Nodes(6).name = 6; Nodes(6).Ptai = 3900; Nodes(6).Q = 160 + delQ;        Nodes(6).Udm = 22;  Nodes(6).PV = 100*2 + delPV;
Nodes(7).name = 7; Nodes(7).Ptai = 3000; Nodes(7).Q = 120 + delQ;        Nodes(7).Udm = 22;  Nodes(7).PV = 100*2 + delPV;
Nodes(8).name = 8; Nodes(8).Ptai = 3500; Nodes(8).Q = 130 + delQ;        Nodes(8).Udm = 22;  Nodes(8).PV = 170*2 + delPV;
Nodes(9).name = 9; Nodes(9).Ptai = 3700; Nodes(9).Q = 150 + delQ;        Nodes(9).Udm = 22;  Nodes(9).PV = 100*2 + delPV;
Nodes(10).name = 10; Nodes(10).Ptai = 3600; Nodes(10).Q = 130 + delQ;    Nodes(10).Udm = 22; Nodes(10).PV = 170*2 + delPV;
Nodes(11).name = 11; Nodes(11).Ptai = 3200; Nodes(11).Q = 110 + delQ;    Nodes(11).Udm = 22; Nodes(11).PV = 150*2 + delPV;
Nodes(12).name = 12; Nodes(12).Ptai = 3500; Nodes(12).Q = 140 + delQ;    Nodes(12).Udm = 22; Nodes(12).PV = 170*2 + delPV;
Nodes(13).name = 13; Nodes(13).Ptai = 3700; Nodes(13).Q = 80 + delQ;    Nodes(13).Udm = 22; Nodes(13).PV = 100*2 + delPV;
Nodes(14).name = 14; Nodes(14).Ptai = 3800; Nodes(14).Q = 100 + delQ;    Nodes(14).Udm = 22; Nodes(14).PV = 100*2 + delPV;
Nodes(15).name = 15; Nodes(15).Ptai = 3800; Nodes(15).Q = 100 + delQ;    Nodes(15).Udm = 22; Nodes(15).PV = 100*2 + delPV;
