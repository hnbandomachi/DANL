...
% Nhap thong so cua nut P = 500 - 600        PV = >400
Nodes(1).name = 1; Nodes(1).Ptai = 540; Nodes(1).Q = 240;        Nodes(1).Udm = 22;  Nodes(1).PV =  500;
Nodes(2).name = 2; Nodes(2).Ptai = 460; Nodes(2).Q = 260;        Nodes(2).Udm = 22;  Nodes(2).PV = 400;
Nodes(3).name = 3; Nodes(3).Ptai = 570; Nodes(3).Q = 270;        Nodes(3).Udm = 22;  Nodes(3).PV = 470;
Nodes(4).name = 4; Nodes(4).Ptai = 530; Nodes(4).Q = 220;        Nodes(4).Udm = 22;  Nodes(4).PV = 430;
Nodes(5).name = 5; Nodes(5).Ptai = 480; Nodes(5).Q = 200;        Nodes(5).Udm = 22;  Nodes(5).PV = 400;
Nodes(6).name = 6; Nodes(6).Ptai = 490; Nodes(6).Q = 260;        Nodes(6).Udm = 22;  Nodes(6).PV = 300;
Nodes(7).name = 7; Nodes(7).Ptai = 500; Nodes(7).Q = 220;        Nodes(7).Udm = 22;  Nodes(7).PV = 350;
Nodes(8).name = 8; Nodes(8).Ptai = 550; Nodes(8).Q = 230;        Nodes(8).Udm = 22;  Nodes(8).PV = 350;
Nodes(9).name = 9; Nodes(9).Ptai = 570; Nodes(9).Q = 250;        Nodes(9).Udm = 22;  Nodes(9).PV = 450;
Nodes(10).name = 10; Nodes(10).Ptai = 560; Nodes(10).Q = 230;    Nodes(10).Udm = 22; Nodes(10).PV = 460;
Nodes(11).name = 11; Nodes(11).Ptai = 520; Nodes(11).Q = 210;    Nodes(11).Udm = 22; Nodes(11).PV = 450;
Nodes(12).name = 12; Nodes(12).Ptai = 550; Nodes(12).Q = 240;    Nodes(12).Udm = 22; Nodes(12).PV = 480;
Nodes(13).name = 13; Nodes(13).Ptai = 570; Nodes(13).Q = 180;    Nodes(13).Udm = 22; Nodes(13).PV = 480;
Nodes(14).name = 14; Nodes(14).Ptai = 480; Nodes(14).Q = 200;    Nodes(14).Udm = 22; Nodes(14).PV = 400;
Nodes(15).name = 15; Nodes(15).Ptai = 480; Nodes(15).Q = 200;    Nodes(15).Udm = 22; Nodes(15).PV = 400;
...
duongdays(7).nut = [2, 6]; duongdays(7).R = 0.148; duongdays(7).L = 0.32; duongdays(7).X = 0.0; duongdays(7).dai = 2;
duongdays(8).nut = [6, 5]; duongdays(8).R = 0.148; duongdays(8).L = 0.32; duongdays(8).X = 0.0; duongdays(8).dai = 2;
duongdays(9).nut = [6, 7]; duongdays(9).R = 0.148; duongdays(9).L = 0.32; duongdays(9).X = 0.0; duongdays(9).dai = 2;
duongdays(10).nut = [7, 11]; duongdays(10).R = 0.148; duongdays(10).L = 0.32; duongdays(10).X = 0.0; duongdays(10).dai = 2;
duongdays(11).nut = [5, 8]; duongdays(11).R = 0.148; duongdays(11).L = 0.32; duongdays(11).X = 0.0; duongdays(11).dai = 2;
duongdays(12).nut = [8, 12]; duongdays(12).R = 0.148; duongdays(12).L = 0.32; duongdays(12).X = 0.0; duongdays(12).dai = 2;
duongdays(13).nut = [8, 13]; duongdays(13).R = 0.148; duongdays(13).L = 0.32; duongdays(13).X = 0.0; duongdays(13).dai = 2;
duongdays(14).nut = [13, 15]; duongdays(14).R = 0.148; duongdays(14).L = 0.32; duongdays(14).X = 0.0; duongdays(14).dai = 2;
